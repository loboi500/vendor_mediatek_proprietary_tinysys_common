...
#define SRAMRC_VAPU_SET		(SRAMRC_APB_BASE+0x78)
#define SRAMRC_VAPU_STA		(SRAMRC_APB_BASE+0x7C)
#define SRAMRC_VAPU_MASK	(SRAMRC_APB_BASE+0x80)
#define SRAMRC_VAPU_RETRY	(SRAMRC_APB_BASE+0x84)
#define SRAMRC_FORCE_CUR_2	(SRAMRC_APB_BASE+0x88)
#define SRAMRC_TIMEOUT_3	(SRAMRC_APB_BASE+0x8C)
#define SRAMRC_VSRAM_STA2	(SRAMRC_APB_BASE+0x90)
#define SRAMRC_APU_MASK		(SRAMRC_APB_BASE+0x94)
#define SRAMRC_GPU_MASK		(SRAMRC_APB_BASE+0x98)
...
#define VAPU_SET_LV0_VAPU_ADDR			(SRAMRC_VAPU_SET)
#define VAPU_SET_LV0_VAPU_MASK			(0xFF)
#define VAPU_SET_LV0_VAPU_SHIFT			(0)
#define VAPU_SET_LV1_VAPU_ADDR			(SRAMRC_VAPU_SET)
#define VAPU_SET_LV1_VAPU_MASK			(0xFF)
#define VAPU_SET_LV1_VAPU_SHIFT			(8)
#define VAPU_SET_LV1_VAPU_THRES_ADDR		(SRAMRC_VAPU_SET)
#define VAPU_SET_LV1_VAPU_THRES_MASK		(0xFF)
#define VAPU_SET_LV1_VGPU_THRES_SHIFT		(16)
#define VAPU_STA_CUR_VAPU_ADDR			(SRAMRC_VAPU_STA)
#define VAPU_STA_CUR_VAPU_MASK			(0xFF)
#define VAPU_STA_CUR_VAPU_SHIFT			(16)
#define VAPU_STA_TAR_VAPU_REQ_ADDR		(SRAMRC_VAPU_STA)
#define VAPU_STA_TAR_VAPU_REQ_MASK		(0xFF)
#define VAPU_STA_TAR_VAPU_REQ_SHIFT		(0)
#define VAPU_MASK_VAPU_DONE_MASK_ADDR		(SRAMRC_VAPU_MASK)
#define VAPU_MASK_VAPU_DONE_MASK_MASK		(0x1)
#define VAPU_MASK_VAPU_DONE_MASK_SHIFT		(1)
#define VAPU_MASK_VAPU_REQ_MASK_ADDR		(SRAMRC_VAPU_MASK)
#define VAPU_MASK_VAPU_REQ_MASK_MASK		(0x1)
#define VAPU_MASK_VAPU_REQ_MASK_SHIFT		(0)
#define VAPU_RETRY_VAPU_RETRY_ADDR		(SRAMRC_VAPU_RETRY)
#define VAPU_RETRY_VAPU_RETRY_MASK		(0x1)
#define VAPU_RETRY_VAPU_RETRY_SHIFT		(0)
#define FORCE_CUR_CUR_2_FORCE_VAPU_ADDR		(SRAMRC_FORCE_CUR_2)
#define FORCE_CUR_CUR_2_FORCE_VAPU_MASK		(0xFF)
#define FORCE_CUR_CUR_2_FORCE_VAPU_SHIFT	(0)
#define TIMEOUT_3_RG_VAPU_REQ_TIMEOUT_ADDR		(SRAMRC_TIMEOUT_3)
#define TIMEOUT_3_RG_VAPU_REQ_TIMEOUT_MASK		(0xFFFF)
#define TIMEOUT_3_RG_VAPU_REQ_TIMEOUT_SHIFT		(0)
#define TIMEOUT_3_RG_VSRAM_REQ_TIMEOUT_ADDR		(SRAMRC_TIMEOUT_3)
#define TIMEOUT_3_RG_VSRAM_REQ_TIMEOUT_MASK		(0xFFFF)
#define TIMEOUT_3_RG_VSRAM_REQ_TIMEOUT_SHIFT		(16)
#define VSRAM_STA2_VSRAM_APU_ADDR		(SRAMRC_VSRAM_STA2)
#define VSRAM_STA2_VSRAM_APU_MASK		(0xFF)
#define VSRAM_STA2_VSRAM_APU_SHIFT		(16)
#define VSRAM_STA2_VSRAM_GPU_ADDR		(SRAMRC_VSRAM_STA2)
#define VSRAM_STA2_VSRAM_GPU_MASK		(0xFF)
#define VSRAM_STA2_VSRAM_GPU_SHIFT		(0)
#define APU_MASK_APU_DONE_MASK_ADDR		(SRAMRC_APU_MASK)
#define APU_MASK_APU_DONE_MASK_MASK		(0x1)
#define APU_MASK_APU_DONE_MASK_SHIFT		(1)
#define APU_MASK_APU_REQ_MASK_ADDR		(SRAMRC_APU_MASK)
#define APU_MASK_APU_REQ_MASK_MASK		(0x1)
#define APU_MASK_APU_REQ_MASK_SHIFT		(0)
#define GPU_MASK_GPU_DONE_MASK_ADDR		(SRAMRC_GPU_MASK)
#define GPU_MASK_GPU_DONE_MASK_MASK		(0x1)
#define GPU_MASK_GPU_DONE_MASK_SHIFT		(1)
#define GPU_MASK_GPU_REQ_MASK_ADDR		(SRAMRC_GPU_MASK)
#define GPU_MASK_GPU_REQ_MASK_MASK		(0x1)
#define GPU_MASK_APU_REQ_MASK_SHIFT		(0)
