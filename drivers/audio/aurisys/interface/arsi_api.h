...
typedef struct AurisysLibInterface {
	...
	/**
	 * =========================================================================
	 *  @brief Set data buffer to library. This is a OpenDSP only api.
	 *
	...
	/**
	 * =========================================================================
	 *  @brief Get data buffer from library. This is a OpenDSP only api.
	 *
	 *  @param id id for library to identify buffer usage
	...
	/**
	 * =========================================================================
	 *  @brief Get arsi api version, please directly use demo_arsi_get_arsi_version
	 *         as implementation.
	 *
	 *  @param version_buf the string to keep arsi api version (max length 128 bytes)
	 *
	 *  @return status_t
	 * =========================================================================
	 */
	status_t (*arsi_get_arsi_version)(string_buf_t *version_buf);


	/**
	 * =========================================================================
	 *  @brief Query the size of the working buffer with slb support.
	 *         This is a OpenDSP only api.
	 *
	 *  @param p_arsi_task_config the task configure
	 *  @param p_arsi_lib_config the lib configure
	 *  @param p_arsi_slb_buf the slb buffer
	 *  @param p_working_buf_size the working buffer size
	 *  @param debug_log_fp debug print function pointer
	 *
	 *  @return status_t
	 * =========================================================================
	 */
	status_t (*arsi_query_working_buf_size_with_slb)(
		const arsi_task_config_t *p_arsi_task_config,
		const arsi_lib_config_t  *p_arsi_lib_config,
	...
	/**
	 * =========================================================================
	 *  @brief Create handler with slb and initialize it. This is a OpenDSP only api.
	 *
	 *  @param p_arsi_task_config the task configure
	 *  @param p_arsi_lib_config the lib configure
	 *  @param p_param_buf the enhancement parameters and lib related configure settings
	...
	/**
	 * =========================================================================
	 *  @brief Query lib slb support, return ture if lib support slb.
	 *         This is a OpenDSP only api.
	 *
	 *  @return bool
	 * =========================================================================
	 */
	bool (*arsi_is_support_slb)(void);


	/**
	 * =========================================================================
	 *  @brief Query sync buffer address and size
	 *         This is a OpenDSP only api.
	 *
	 *  @param p_arsi_d2u_buf the dl to ul buffer.
	 *  @param p_arsi_d2u_buf the ul to dl buffer.
	 *  @param p_handler the lib handler
	 *
	 *  @return status_t
	 * =========================================================================
	 */
	status_t (*arsi_query_sync_buf)(
