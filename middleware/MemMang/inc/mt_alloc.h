...
#ifndef __MT_ALLOC_H__
#define __MT_ALLOC_H__

#define ALIGNED_MAL_WATERMARK 0xdeadbeef

/* aligned value must be a multiple of portBYTE_ALIGNMENT */
void *aligned_malloc(size_t nbytes, size_t aligned);
/* aligned_free can only free the memory from aligned_malloc */
